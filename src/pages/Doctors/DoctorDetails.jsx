            ...
            <div className='flex items-center gap-5'>
              ...
              <div >
                ...
                <p className="text__para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]">
                  Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quam ipsa ipsum labore! Dolor!                </p>

              </div>
            </div>

            <div className="mt-[50px] border-b border-solid boder-[#0066ff34]">
              <button
